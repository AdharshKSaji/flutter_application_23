...
import 'package:flutter_application_23/dammydb.dart';
          ...
          Container(
            ...
            child: Row(
              children: [
                Expanded(
                  child: TextField(
                    decoration: InputDecoration(
                      hintText: "Write Here",suffixIcon: Icon(Icons.photo_camera),prefixIcon: Icon(Icons.mood),
                ...
                ),IconButton(onPressed: (){}, icon: Icon(Icons.mic,color: Colors.blue,))
              ],
            ),
          ),
        ],
